...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('session', models.DateField(default=datetime.datetime(2021, 7, 5, 7, 58, 2, 847134, tzinfo=utc))),
        ...
        migrations.AddField(
            model_name='course',
            name='course_session',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='courses.session'),
        ),
        migrations.AddField(
            model_name='course',
            name='curriculum',
